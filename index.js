...
CFonts.say(`Script Ini dibuat oleh @FanzOffc`, {
   font: 'console',
    align: 'center',
...
console.log(color(time,"yellow"),color("[ + ]","green"),color("Connecting...","aqua"))
var date = new Date();
...
var tampilHari = "Waktu: " + jams + " Hari";

console.log(color(tampilTanggal, "pink"));
console.log(color(tampilWaktu, "yellow"));
console.log(color(tampilHari, "blue"));
